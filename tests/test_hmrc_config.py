...
def test_sandbox_urls() -> None:
	...
	assert env.oauth_authorize_url == "https://test-www.tax.service.gov.uk/oauth/authorize"
	assert env.oauth_token_url == "https://test-api.service.hmrc.gov.uk/oauth/token"


def test_production_urls() -> None:
	assert HMRCEnvironment.PRODUCTION.api_base_url == "https://api.service.hmrc.gov.uk"
	assert HMRCEnvironment.PRODUCTION.oauth_authorize_url == "https://www.tax.service.gov.uk/oauth/authorize"
